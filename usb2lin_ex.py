...
from ctypes import *
import platform
from USB2LIN.usb_device import *
...
LIN_EX_ERR_NO_DEVICE_CONNECTED = (-7)  # 未扫描到设备(设备未连接)
LIN_EX_ERR_CONFIG_FAILED = (-8)  # LIN参数配置失败
LIN_EX_ERR_OPEN_DEVICE_FAILED = (-9)  # LIN设备打开失败
LIN_EX_ERR_LIN_BREAK_FAILED = (-10)  # 唤醒失败
...
# 设置从模式下ID操作模式
class LIN_EX_MSG(Structure):  # 创建结构体
    _fields_ = [
